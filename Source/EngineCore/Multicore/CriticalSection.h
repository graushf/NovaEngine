...
class CriticalSection : public Nv_noncopyable
{
public:
	CriticalSection()
	{
...
/*
 ...
 Usage
		...
		when you need protected accesss to a resource, do the
		following:
		1. Create a Critical Section associated with the resource
		2. Embody the code accessing the resource with braces { }
 ...
 Example
		...
		// 'this' from being accessed while we need safe access
		// to a resource.


		// code that does need resource locking
...
*/
class ScopedCriticalSection : public Nv_noncopyable
{
public:
