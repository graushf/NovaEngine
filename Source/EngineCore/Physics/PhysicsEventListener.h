...
public:
	...
	{
		return IEventDataPtr(Nv_NEW EvtData_PhysTrigger_Leave(m_triggerID, m_other));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(Nv_NEW EvtData_PhysCollision(m_ActorA, m_ActorB, m_SumNormalForce, m_SumFrictionForce, m_CollisionPoints));
	}
...
public:
	...
	virtual IEventDataPtr VCopy() const
	{
		return IEventDataPtr(Nv_NEW EvtData_PhysSeparation(m_ActorA, m_ActorB));
	}
